                                                                        ...
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <strong >Message venant du site web www.jcitconsultingusa.com   </strong>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10t es-p10b" align="left">
                                                                                    @if($jobData['email'])
                                                                                    <strong >Contact :  </strong> {{ $jobData['email'] }}
                                                                                    @endif
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10t es-p10b" align="left">
                                                                                    @if($jobData['name'])
                                                                                    <strong >Nom :  </strong> {{ $jobData['name'] }}
                                                                                    @endif
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10t es-p10b" align="left">
                                                                                    @if($jobData['jobChosen'])
                                                                                    <strong >Service :  </strong> {{ $jobData['jobChosen'] }}
                                                                                    @endif
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10b" align="left">                                                                                        
                                                                                    <p><strong> Message : </strong> {{ $jobData['experience'] }} </p>
                                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10b" align="center">
                                                                                        <p>contact@jcitconsultingusa.com</p>
                                                                                    </td>
                                                                                </tr>
                                                                          
                                                                                <tr>
                                                                                    <td class="esd-block-text" align="center">
                                                                                        <p>Copyright © {{ date("Y") }} <strong>JCIT Consulting USA</strong>, Tous droits réservés.</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
