<template>
    <!-- ======================= Start Banner ===================== -->
    <div class="utf_main_banner_area" style="background-image:url(website/assets/img/slider_bg2.png);" data-overlay="8">
        <div class="container">
            <div class="col-md-8 col-sm-10">
                <div class="caption cl-white home_two_slid">
                    <h2>Search Between More Then <span class="theme-cl">50,000</span> Open Jobs.</h2>
                    <p>Trending Jobs Keywords: <span class="trending_key"><a href="#">Web Designer</a></span>
                        <span class="trending_key"><a href="#">Web Developer</a></span> <span
                            class="trending_key"><a href="#">IOS Developer</a></span> <span
                            class="trending_key"><a href="#">Android Developer</a></span>
                    </p>
                </div>
    ...
    <section class="padd-top-80 padd-bot-80">
        <div class="container">
            ...
            <div class="col-md-12 mrg-top-20 text-center">
                <router-link to="/jobs" class="btn theme-btn btn-m">View more</router-link>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-12 mrg-top-20 text-center">
                        <router-link to="/training" class="btn theme-btn btn-m">View more</router-link>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="newsletter theme-bg" style="background-image:url(website/assets/img/bg-new.png)">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                ...
                <div class="modal-body">
                    ...
                    <ul class="nav nav-tabs nav-advance theme-bg" role="tablist">
                        <li class="nav-item active"> <a class="nav-link" data-toggle="tab" href="#employer"
                                role="tab"> <i class="ti-user"></i> Job Seeker</a> </li>
